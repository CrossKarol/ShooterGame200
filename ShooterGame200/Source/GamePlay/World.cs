...
namespace ShooterGame200
{
    public class World
    {
        ...
        public World(PassObject RESETWORLD,int LEVELID, PassObject CHANGEGAMESTATE)
        {
            ...
            bkg = new TileBkg2d("2D\\UI\\Backgrounds\\StandardSnow", new Vector2(-100, -100), new Vector2(120, 100), new Vector2(grid.totalPhysicalDims.X + 100, grid.totalPhysicalDims.Y + 100));
